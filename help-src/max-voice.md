...
**Settings → Cora Max → Audio → Wake-word listening** turns background listening off. Tapping the Cora Assistant icon still works, which is the setting to use if you would rather the screen were not listening all the time.
