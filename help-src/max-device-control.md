...
Pump and gyre day programs can be authored at the wall as well as on the phone. The editor is the same: a day graph, a period list, and an action row. See [Scheduling equipment](/help/mobile-schedules).

## Outlets

Outlets are also reachable from the **Outlets & Feed** drawer at the bottom of the dashboard, which lists every outlet in one place. See [Outlets and controls](/help/max-controls).
