...
Every journey moves through the same stages, and you can see which one you are in:
...
For a problem — nutrients out of range, coral not doing well, something drifting you cannot explain.

Cora starts one when it sees a pattern worth pursuing, and you can start one yourself.
