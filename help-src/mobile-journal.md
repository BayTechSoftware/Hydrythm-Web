...
An entry you marked as a **concern** or an **emergency** carries an **Analyze** action. It hands that entry, with the tank's readings around the same date, to [Cora Assistant](/help/mobile-assistant) and comes back with an assessment. Use it when you have written down something that worries you and want a second read on it.
