...
- **Vacation mode** — tells Cora you are away, so it treats gaps in hand-logged readings differently instead of nagging
...
This is what turns "5 ml" into an actual predicted change in your tank, so dose maths and consumption tracking depend on it. Add the products you actually use and Cora does the arithmetic.
