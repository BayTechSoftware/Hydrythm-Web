...
The nine tile types (Value, Gauge, Graph, Status, Outlet, ReefBeat, Apex module, Jecod and Maxspect *(beta)*) are described in the **[Widget reference](/help/mobile-widgets)**.
